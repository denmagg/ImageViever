...
//    
//    //MARK: properties
//    var (imageWidth, imageHeight): (Float, Float) = (0, 0)
...
//        print(imageScrollView.heightAnchor)
//        
...
//                    make.height.equalTo(imageHeight).inset(-748/2)
//                    make.width.equalTo(imageWidth).inset(-375/2)
...
//                    make.top.equalToSuperview().inset(-getNavigationBarHeight() - getStatusBarHeight())
//                    make.bottom.equalToSuperview().inset(-getNavigationBarHeight() - getStatusBarHeight())
//                    make.height.equalTo(imageHeight).inset(748)
//                    make.width.equalTo(imageWidth).inset(375)
//                    make.leading.trailing.equalToSuperview()
//                }
//            }
//        }
...
////        let (width, height) = calculateImageSize()
////        let zoomRect = CGRect(x: CGFloat(0), y: CGFloat(0), width: CGFloat(376), height: CGFloat(813))
////        imageScrollView.zoom(to: zoomRect, animated: true)
//        imageScrollView.zoomScale = 0.99
//        let (imW, imH) = calculateImageSize()
//        (originalImageWidth, originalImageHeight) = (CGFloat(imW),CGFloat(imH))
//    }
//    
//    //MARK: methods
//    
...
//    }
//    
//    func calculateImageSize() -> (Float, Float) {
...
////        imageScrollView.minimumZoomScale = 1 / imageScrollView.zoomScale
////        
//        //MARK: ебать
//        imageScrollView.imageView.snp.updateConstraints { make in
//            make.height.equalTo(imageHeight)

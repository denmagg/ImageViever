...
//                    } else {
//                        frameToCenter.origin.y = 0 - getNavigationBarHeight() - getStatusBarHeight()
//                        //frameToCenter = CGRect(x: frameToCenter.origin.x, y: frameToCenter.origin.y, width: frameToCenter.width, height: frameToCenter.height + getStatusBarHeight())
//                        //imageScrollView.contentOffset = CGPoint(x: 0, y: 100)
//                    }
//                }
//            }
//        } else {
...
//                if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                    if isStatusBarHidden {
//                        frameToCenter.origin.y = (boundsSize.height - frameToCenter.size.height) / 2 - getStatusBarHeight()// - getNavigationBarHeight()//???сюда
//                    } else {
//                        frameToCenter.origin.y = (boundsSize.height - frameToCenter.size.height) / 2 - getStatusBarHeight() - getNavigationBarHeight()//???сюда
//                    }
//                } else {
...
//            if isStatusBarHidden {
//                if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - getNavigationBarHeight() - 32)
//                    print("\(getStatusBarHeight())--------")
//                }
//            } else {
//                if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - getNavigationBarHeight() - getStatusBarHeight() - 32)
//                    print("-----\(getStatusBarHeight())")
//                } else {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - getNavigationBarHeight() - getStatusBarHeight())
//                }
//            }
//        } else {
//            if isStatusBarHidden {
//                if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale - getNavigationBarHeight() * 2 - 22, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - 21)
//                    print("\(getNavigationBarHeight())--------")
//                }
//            } else {
//                if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale - getNavigationBarHeight() * 2 - 22, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - getNavigationBarHeight() - 21)
//                    print("-----\(getNavigationBarHeight())")
//                } else {
//                    imageScrollView.contentSize = CGSize(width: (imageScrollView.imageView.image?.size.width)! * imageScrollView.zoomScale, height: (imageScrollView.imageView.image?.size.height)! * imageScrollView.zoomScale - getNavigationBarHeight())
//                }
//            }
//        }
...
//    let contentOffset = CGPoint(x: 0.0, y: imageScrollView.imageView.frame.origin.y)
//    print("contentOffset \(contentOffset)")
//    if isPortrait{
//        if isStatusBarHidden {
//            if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                //imageScrollView.co
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale, height: imageHeight * imageScrollView.zoomScale - getNavigationBarHeight() - 32)), animated: true)
//                print("\(getStatusBarHeight())--------")
//            } else {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale, height: imageHeight * imageScrollView.zoomScale)), animated: true)
//            }
//        } else {
//            if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale, height: imageHeight * imageScrollView.zoomScale - getNavigationBarHeight() - getStatusBarHeight() - 32)), animated: true)
//                print("-----\(getStatusBarHeight())")
//            } else {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale, height: imageHeight * imageScrollView.zoomScale - getNavigationBarHeight() - getStatusBarHeight())), animated: true)
//            }
//        }
//    } else {
//        if isStatusBarHidden {
//            if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale - getNavigationBarHeight() * 2 - 22, height: imageHeight * imageScrollView.zoomScale - 21)), animated: true)
//                print("\(getNavigationBarHeight())--------")
//            }
//        } else {
//            if (bottomPadding != 0) && (UIDevice.current.userInterfaceIdiom == .phone) {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale - getNavigationBarHeight() * 2 - 22, height: imageHeight * imageScrollView.zoomScale - getNavigationBarHeight() - 21)), animated: true)
//                print("-----\(getNavigationBarHeight())")
//            } else {
//                imageScrollView.scrollRectToVisible(CGRect(origin: contentOffset, size: CGSize(width: imageWidth * imageScrollView.zoomScale, height: imageHeight * imageScrollView.zoomScale - getNavigationBarHeight())), animated: true)
//            }
//        }
//    }
//}
